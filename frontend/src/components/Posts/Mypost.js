...
function Myposts() {
  ...
  useEffect(()=>{
    ...
    axios.get('https://3000-venkateshjn-mediumclone-012z6jj5k9g.ws-us103.gitpod.io/get/myPost', {headers})
    .then((response) => {
  ...
  axios.delete(`https://3000-venkateshjn-mediumclone-012z6jj5k9g.ws-us103.gitpod.io/delete/posts/${id}`,{headers})
    .then((response) => {
