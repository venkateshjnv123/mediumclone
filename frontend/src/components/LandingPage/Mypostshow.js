      ...
      <div className="postsPage py-[40px]">
        ...
        <div className="btnsMainDiv py-[15px] px-[10px]">
          ...
          <div className="btnsRightDiv gap-8">
            <div className="btnsDiv">
                <button className="rounded-full bg-slate-200 py-1 px-2" onClick={()=>handleedit()}>Edit</button>
            </div>
            <div className="btnsDiv">
                <button className="rounded-full bg-slate-200 py-1 px-2" onClick={()=>handledelete()}>Delete</button>
            </div>
            <div className="btnsDiv">
              <div>
                <span>
