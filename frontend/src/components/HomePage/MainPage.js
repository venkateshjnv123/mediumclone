...
const Datacards = ({ blogsdata }) => {
  return (
    <>
      {blogsdata.map((blog) => (
        <div className="md:w-[90%] md:mx-auto md:w-90 border-b p-4 mb-4">
          <div>
            <h3 className="text-xl mb-2 font-[700]">{blog.title}</h3>
          </div>
          {/* Author Name */}
    ...
    <div className="mainpage">
      ...
      <div className="flex items-star overflow-x-hidden">
        <div className="w-full md:w-2/3 md:mr-2 md:mx-4">
          <div className="rounded-[25px] px-4 py-2 mr-4 ">
            <input
              type="text"
          ...
          <div className="filterDivMain my-[20px] items-center p-4 border rounded shadow-md">
            <div className="filterDiv w-fit md:w-4/5">
              <div className="w-fit md:w-full filterDivSub my-[10px]">
          ...
          <div className="w-full mt-4">
            <Datacards blogsdata={poststoshow} />
          </div>
        </div>
