...
const getFilteredPosts = () => {
  ...
  if (authorName) {
    filteredPosts = filteredPosts.filter((post) => post.author.toLowerCase().includes(authorName.toLowerCase()));
  }
    ...
    <div className="mainpage">
      ...
      <div className="rounded-lg px-4 py-2 mr-4 ">
          <input
            ...
            className="bg-slate-200 w-56 sm:w-48 focus:outline-none px-4 py-2 rounded-lg"
          />
        </div>
      ...
      <div className="mb-4">
        <label className="text-gray-700 font-bold mr-2">Start Date:</label>
        <input
          type="date"
          value={startDate}
      ...
      <div className="mb-4">
        <label className="text-gray-700 font-bold mr-2">End Date:</label>
        <input
          type="date"
          value={endDate}
